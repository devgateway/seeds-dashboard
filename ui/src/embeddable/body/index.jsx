...
//  <line stroke="#000" x1="" y1="153.25657745748686" x2="-57.0522107618267" y2="110.24777579617485"/>
    ...
    componentDidMount() {
        ...
        const left = [
            {label: 'Oropharynx', selector: '.stomach', tx: 90, ty: 60},
            {label: 'Larynx', selector: '.larynx', tx: 80, ty: 90},
            {label: 'Esophagus', selector: '.stomach', tx: 77, ty: 95},
            {label: 'Trachea, bronchus and lung', selector: '.larynx', tx: 80, ty: 120},
            {label: 'Acute myeloid leukemia', selector: '.blood', tx: 90, ty: 200},
            {label: 'Stomach', selector: '.stomach', tx: 80, ty: 150},
            {label: 'Liver', selector: '.stomach', tx: 80, ty: 150},
            {label: 'Pancreas', selector: '.stomach', tx: 105, ty: 160},
            {label: 'Kidney', selector: '.stomach', tx: 65, ty: 185},
            {label: 'Bladder', selector: '.stomach', tx: 65, ty: 185},
            {label: 'Colorectal', selector: '.stomach', tx: 90, ty: 220}]
        ...
        return (
            ...
            <Container className="body parts">
                <svg className="body root" viewBox="-300 0 800 500" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text x="200" y="60" className="title">Chronic Diseases</text>
