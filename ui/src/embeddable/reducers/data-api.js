...
const CROSS_COUNTRY_AVAILABILITY_SEED_SMALL_PACKAGES_API = `${SURVEY_API}/chart/cc/availabilitySeedSmallPackages`;

const ADEQUACY_ACTIVE_BREEDERS_API = `${SURVEY_API}/chart/cc/adequacyActiveBreeders`;
const AVAILABILITY_BASIC_SEED_API = `${SURVEY_API}/chart/cc/availabilityBasicSeed`;
const ADEQUACY_SEED_INSPECTION_SERVICES_API = `${SURVEY_API}/chart/cc/ratingSeedInspectors`;
const ADEQUACY_EXTENSION_SERVICES_API = `${SURVEY_API}/chart/cc/agriculturalExtensionServices`;
const ADEQUACY_AGRODEALER_NETWORK_API = `${SURVEY_API}/chart/cc/agrodealerNetwork`;
const SATISFACTION_VARIETY_RELEASE_PROCESS_API = `${SURVEY_API}/chart/cc/varietyReleaseProcess`;
const SATISFACTION_SEED_REGULATIONS_API = `${SURVEY_API}/chart/cc/satisfactionLawRegulation`;
const ADEQUACY_GOVERNMENT_EFFORT_COUNTERFEIT_SEED_API = `${SURVEY_API}/chart/cc/satisfactionGovernmentEffortCounterfeitSeed`;
...
const APIS = {
    ...
    [CROSS_COUNTRY_NUMBER_SEED_INSPECTORS]: NUMBER_SEED_INSPECTORS_BY_COUNTRY_API,
    ...
    [CROSS_COUNTRY_AVAILABILITY_SEED_SMALL_PACKAGES]: CROSS_COUNTRY_AVAILABILITY_SEED_SMALL_PACKAGES_API,
    [ADEQUACY_ACTIVE_BREEDERS]: ADEQUACY_ACTIVE_BREEDERS_API,
    [AVAILABILITY_BASIC_SEED]: AVAILABILITY_BASIC_SEED_API,
    [ADEQUACY_SEED_INSPECTION_SERVICES]: ADEQUACY_SEED_INSPECTION_SERVICES_API,
    [ADEQUACY_EXTENSION_SERVICES]: ADEQUACY_EXTENSION_SERVICES_API,
    [ADEQUACY_AGRODEALER_NETWORK]: ADEQUACY_AGRODEALER_NETWORK_API,
    [SATISFACTION_VARIETY_RELEASE_PROCESS]: SATISFACTION_VARIETY_RELEASE_PROCESS_API,
    [SATISFACTION_SEED_REGULATIONS]: SATISFACTION_SEED_REGULATIONS_API,
    [ADEQUACY_GOVERNMENT_EFFORT_COUNTERFEIT_SEED]: ADEQUACY_GOVERNMENT_EFFORT_COUNTERFEIT_SEED_API,
}
...
export const getData = ({ source, app, params }) => {
    ...
    if (app === COUNTRY_INFO && params && (params[SELECTED_COUNTRY] || params[DEFAULT_COUNTRY_ID])) {
        ...
        || app === CROSS_COUNTRY_NUMBER_SEED_INSPECTORS
