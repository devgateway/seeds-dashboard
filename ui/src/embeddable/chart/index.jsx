...
const BarChar = (props) => {
    ...
    return <Bar groupMode={groupMode} height={height} legends={legends} colors={colors} options={options} format={{ style: "percent", currency: "EUR" }}></Bar>
}
...
const SeedInspectors = (props) => {
    ...
    return <Bar groupMode={groupMode} height={height} legends={legends} colors={colorsSI} options={options} format={{ style: "percent", currency: "EUR" }}></Bar>
}
...
const PieChart = (props) => {
    ...
    return <HalfPie height={height} legends={legends} colors={colors} options={options} format={{ style: "percent", currency: "EUR" }}></HalfPie>
}

const Diverging = (props) => {
    const { data, legends, colors, height } = props
    const options = buildDivergingOptions(data, true)
    return <Diverging height={height} legends={legends} colors={colors} options={options} format={{ style: "percent", currency: "EUR" }}></Diverging>
}
